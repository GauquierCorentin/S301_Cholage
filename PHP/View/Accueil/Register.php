...
<form method="post">
    <div class="form-group">
        <input type="email" class="form-control form-acc" placeholder="Email" name="mail" id="mail"
               aria-describedby="basic-addon1" required>
    </div>

    <div class="form-group">
        <input type="text" class="form-control form-acc" placeholder="Nom" name="nom" id="nom"
               aria-describedby="basic-addon1" required>
    </div>

    <div class="form-group">
        <input type="text" class="form-control form-acc" placeholder="Prenom" name="prenom" id="prenom"
               aria-describedby="basic-addon1" required>
    </div>

    <div class="form-group">
        <input type="text" class="form-control form-acc" placeholder="Numero Tel" name="tel" id="tel"
               aria-describedby="basic-addon1" required>
    </div>

    <div class="form-group form-pw">
        <input type="password" class="form-control form-acc" placeholder="Password" name="mdp" id="mdp"
               aria-describedby="basic-addon1" required>
        <button type="button" name="seePW" id="seePW" class="btn btn-info btn-PW" onclick="changer('mdp')">0</button>
    </div>

    <div class="form-group">
        <input type="password" class="form-control form-acc" placeholder="Password Check" name="mdpcheck" id="mdpcheck"
               aria-describedby="basic-addon1" required>
    </div>
